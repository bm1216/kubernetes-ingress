...
class TestConfigRollbackStartup:
    ...
    def test_startup_ingress_partial_exclusion(
        ...
        print("Step 1: stop the ingress controller before creating startup resources")
        scale_deployment(kube_apis.v1, kube_apis.apps_v1_api, ingress_controller, ic_namespace, 0)
        ...
        print("Step 4: valid ingress serves traffic and invalid ingress is excluded")
        ...
        print("Step 5: excluded ingress gets an error event, valid ingress does not, and the exclusion is logged")
        ...
        print("Step 6: clean up the excluded ingress")
        delete_ingress(kube_apis.networking_v1, invalid_ingress_name, test_namespace)
        wait_before_test()

        print("Step 7: clean up the remaining startup resources")
    ...
    def test_startup_ingress_all_valid(
        ...
        print("Step 2: create valid startup resources")
        ...
        print("Step 3: scale the ingress controller back up")
        scale_deployment(kube_apis.v1, kube_apis.apps_v1_api, ingress_controller, ic_namespace, 1)
        ensure_connection_to_public_endpoint(
            ingress_controller_endpoint.public_ip,
            ingress_controller_endpoint.port,
        ...
        print("Step 4: controller becomes Ready, both ingresses serve traffic, and no exclusions are logged")
        ...
        print("Step 6: clean up the startup ingresses")
